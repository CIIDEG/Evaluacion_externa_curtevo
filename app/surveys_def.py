...
ENCUESTA_ESTUDIANTES = {
    ...
    "sections": [
        {"title": "A. Datos generales", "questions": [
            ...
            {"id":"grado","label":"Grado / Condición","type":"select","options":["1° secundaria","2° secundaria","3° secundaria","4° secundaria","5° secundaria","Egresado/a","Otro (especificar abajo)"],"required":True},
            {"id":"grado_otro","label":"Si elegiste «Otro», especifica aquí (p. ej. primaria, formación técnica, etc.)","type":"text"},
